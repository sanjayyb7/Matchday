  ...
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        ...
        "pointer-events-none fixed inset-0 z-50 bg-black/70 [-webkit-backdrop-filter:blur(12px)] backdrop-blur-md transition-[opacity] duration-[var(--dur-slow)] ease-[var(--ease-out)] data-open:pointer-events-auto data-ending-style:pointer-events-none data-ending-style:opacity-0 data-ending-style:duration-[var(--dur-ui)] data-starting-style:opacity-0",
        className
      )}
      {...props}
    />
